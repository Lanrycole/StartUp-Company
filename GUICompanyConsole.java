...
public class GUICompanyConsole extends JFrame {
	...
	public static void main(String[] args) {
		...
		screenX = (int) (screenSize.getWidth() / 3);
		screenY = (int) screenSize.getHeight() / 3;
	...
	public class LoadJFrame extends JFrame {
		...
		private void loadPanels() {
			...
			empName.setFont(new Font("Tahoma", Font.PLAIN, 16));
			...
			empNumber.setFont(new Font("Tahoma", Font.PLAIN, 16));
			...
			empStartDate.setFont(new Font("Tahoma", Font.PLAIN, 16));
			...
			empSalary.setFont(new Font("Tahoma", Font.PLAIN, 16));
			...
			empExtraInfo.setFont(new Font("Tahoma", Font.PLAIN, 16));
			empInfoPanel.add(txtExtraInfo, c.setGrid(9, 0, txtSize));
			txtExtraInfo.setFont(new Font("Tahoma", Font.PLAIN, 20));
		...
		private void loadButtonHandlers(JFrame frame) {
			...
			findEmployeeBtn.addActionListener(event -> {
				try {
					...
					if (emp != null)
						...
						Employee empWrong = new Manager("#####", 0, invalidDate, 0.0, "Not Found");
			...
			// following the pattern indicated above. Of course, since different buttons
			// perform
